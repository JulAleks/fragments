...
//   try {
//     logger.info(`Deleting metadata and raw data for fragment ${id} owned by ${ownerId}`);

//     // Delete metadata first
//     try {
//       await metadata.del(ownerId, id);
//       logger.info(`Metadata for fragment ${id} deleted`);
//     } catch (err) {
//       logger.warn(`Metadata for fragment ${id} not found or already deleted: ${err.message}`);
//     }

//     // Delete raw data
//     try {
//       await data.del(ownerId, id);
//       logger.info(`Raw data for fragment ${id} deleted`);
//     } catch (err) {
//       logger.warn(`Raw data for fragment ${id} not found or already deleted: ${err.message}`);
//     }

//     // If S3 is active, delete the object
//     if (process.env.AWS_S3_BUCKET_NAME) {
//       try {
//         logger.info(`Deleting fragment data from S3 with key: ${s3Key}`);
...
async function deleteFragment(ownerId, id) {
  ...
  try {
    ...
    // If S3 is active, delete the raw data from S3
    if (process.env.AWS_S3_BUCKET_NAME) {
      try {
